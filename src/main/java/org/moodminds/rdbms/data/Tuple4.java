...
/**
 * An RDBMS relation 4-attributes tuple.
 *
...
public interface Tuple4<V1, V2, V3, V4> extends Tuple,
        org.moodminds.elemental.Tuple4<V1, V2, V3, V4> {
    ...
    @Override
    default V1 get1st() {
        return org.moodminds.elemental.Tuple4.super.get1st();
    }
    ...
    @Override
    default V2 get2nd() {
        return org.moodminds.elemental.Tuple4.super.get2nd();
    }
    ...
    @Override
    default V3 get3rd() {
        return org.moodminds.elemental.Tuple4.super.get3rd();
    }
    ...
    @Override
    default V4 get4th() {
        return org.moodminds.elemental.Tuple4.super.get4th();
    }
}
