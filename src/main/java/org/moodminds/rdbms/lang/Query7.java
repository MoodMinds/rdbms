...
/**
 * An RDBMS {@link Relation} 7-attributes result retrieving statement.
 *
 ...
 */
public interface Query7<V1, V2, V3, V4, V5, V6, V7> extends Query<Relation<Tuple7<V1, V2, V3, V4, V5, V6, V7>>> {}
