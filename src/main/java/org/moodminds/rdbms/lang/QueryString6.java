...
/**
 * An RDBMS {@link Relation} 6-attributes result retrieving SQL string statement.
 *
 ...
 */
public interface QueryString6<V1, V2, V3, V4, V5, V6>
        extends Query6<V1, V2, V3, V4, V5, V6>, QueryString<Relation<Tuple6<V1, V2, V3, V4, V5, V6>>> {}
