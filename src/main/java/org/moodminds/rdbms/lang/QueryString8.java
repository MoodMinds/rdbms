...
/**
 * An RDBMS {@link Relation} 8-attributes result retrieving SQL string statement.
 *
 ...
 */
public interface QueryString8<V1, V2, V3, V4, V5, V6, V7, V8>
        extends Query8<V1, V2, V3, V4, V5, V6, V7, V8>, QueryString<Relation<Tuple8<V1, V2, V3, V4, V5, V6, V7, V8>>> {}
