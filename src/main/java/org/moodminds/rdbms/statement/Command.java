...
/**
 * Root interface for commands (expressions, statements) that can be parameterized.
 */
public interface Command {

    /**
     * Return the parameters of this command object.
     *
     * @return the parameters of this command object
     */
    ...
    /**
     * Return the parameter of this command object by the given name.
     *
    ...
    /**
     * Represents an RDBMS SQL parameter.
     *
    ...
    /**
     * Represents an input value RDBMS SQL parameter.
     *
     * @param <V> the corresponding type of the parameter
     */
    ...
    /**
     * Represents an output value RDBMS SQL parameter.
     *
     * @param <V> the corresponding type of the parameter
     */
    ...
    /**
     * Represents an input-output value RDBMS SQL parameter.
     *
     * @param <V> the corresponding type of the parameter
     */
    ...
    /**
     * Represents a multiple input values RDBMS SQL parameter.
     *
     * @param <V> the corresponding type of the parameter
     */
