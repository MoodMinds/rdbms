...
/**
 * An exception indicating that feature is not supported on the resource level.
 */
public class SupportException extends NonTransientException {

    private static final long serialVersionUID = -8382519158240121349L;
     ...
     */
    public SupportException(String message, String sqlState) {
     ...
     */
    public SupportException(String message, String sqlState, int errorCode) {
     ...
     */
    public SupportException(String message, String sqlState, int errorCode, Throwable cause) {
     ...
     * @param cause the reason cause
     */
    public SupportException(String message, String sqlState, Throwable cause) {
     ...
     */
    @Override
    public SupportException getException() {
        return (SupportException) super.getException();
    }
}
