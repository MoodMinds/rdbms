...
/**
 * Streaming route definition function by the {@link Flow} and 3 argument values level 3.
 *
 ...
 */
@FunctionalInterface
public interface Stream3Level3<I1, I2, I3, V, E extends Exception, $S, $T extends Types>
        extends Route3Level3<I1, I2, I3, E, $S, $T, Emitting<? extends V>>, Stream3Level2<I1, I2, I3, V, E, $S, $T> {}
