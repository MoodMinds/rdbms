...
/**
 * Action route definition function by the {@link Flow} and 3 argument values level 1.
 *
 ...
 */
@FunctionalInterface
public interface Action3Level1<I1, I2, I3, E extends Exception, $S, $T extends Types>
        extends Route3Level1<I1, I2, I3, E, $S, $T, Flowing<?>> {}
