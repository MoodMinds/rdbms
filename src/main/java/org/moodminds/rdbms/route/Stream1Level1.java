...
/**
 * Streaming route definition function by the {@link Flow} and argument value level 1.
 *
 ...
 */
@FunctionalInterface
public interface Stream1Level1<I, V, E extends Exception, $S, $T extends Types>
        extends Route1Level1<I, E, $S, $T, Emitting<? extends V>> {}
