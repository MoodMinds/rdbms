...
/**
 * Streaming route definition function by the {@link Flow} and 2 argument values level 1.
 *
 ...
 */
@FunctionalInterface
public interface Stream2Level1<I1, I2, V, E extends Exception, $S, $T extends Types>
        extends Route2Level1<I1, I2, E, $S, $T, Emitting<? extends V>> {}
