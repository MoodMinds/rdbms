...
/**
 * Route definition function by the {@link Flow} and 4 argument values level 2.
 *
 ...
 */
@FunctionalInterface
public interface Route4Level2<I1, I2, I3, I4, E extends Exception, $S, $T extends Types, $R extends Routing<?>>
        extends Route4Level1<I1, I2, I3, I4, E, $S, $T, $R> {}
