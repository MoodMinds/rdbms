...
/**
 * Route definition function by the {@link Flow} and argument value level 1.
 *
 ...
 */
@FunctionalInterface
public interface Route1Level1<I, E extends Exception, $S, $T extends Types, $R extends Routing<?>>
        extends Route1Level0<I, E, $S, $T, $R> {}
