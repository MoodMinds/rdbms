...
/**
 * Route definition function by the {@link Flow} and 2 argument values level 3.
 *
 ...
 */
@FunctionalInterface
public interface Route2Level3<I1, I2, E extends Exception, $S, $T extends Types, $R extends Routing<?>>
        extends Route2Level2<I1, I2, E, $S, $T, $R> {}
