...
/**
 * Streaming route definition function by the {@link Flow} and 2 argument values level 3.
 *
 ...
 */
@FunctionalInterface
public interface Stream2Level3<I1, I2, V, E extends Exception, $S, $T extends Types>
        extends Route2Level3<I1, I2, E, $S, $T, Emitting<? extends V>>, Stream2Level2<I1, I2, V, E, $S, $T> {}
