...
/**
 * Route definition function by the {@link Flow} and 6 argument values level 0.
 *
 ...
 */
@FunctionalInterface
public interface Route6Level0<I1, I2, I3, I4, I5, I6, E extends Exception, $S, $T extends Types, $R extends Routing<?>>
        extends Route6<Flow<?, ? extends $S, ? extends $T, E>, I1, I2, I3, I4, I5, I6, $R> {}
