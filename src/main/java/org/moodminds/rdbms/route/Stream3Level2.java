...
/**
 * Streaming route definition function by the {@link Flow} and 3 argument values level 2.
 *
 ...
 */
@FunctionalInterface
public interface Stream3Level2<I1, I2, I3, V, E extends Exception, $S, $T extends Types>
        extends Route3Level2<I1, I2, I3, E, $S, $T, Emitting<? extends V>>, Stream3Level1<I1, I2, I3, V, E, $S, $T> {}
